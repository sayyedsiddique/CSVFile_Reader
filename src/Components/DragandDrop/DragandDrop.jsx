...
import DocumentImage from "../../assets/images/svg/document.png";
    ...
    <div className="d-flex flex-column justify-content-center gap-2 w-100">
      ...
      <div className="d-flex">
        <div {...getRootProps({ className: `${additionalClass}` })}>
          ...
          {isDragActive ? (
            isDragReject ? (
              <p className="my-4 py-2">Not an csv file</p>
            ) : (
            ...
            (fileErrors?.length > 0 ? (
              ...
              <>
                <div
                  className="drop_inner_box d-flex fit-content justify-content-center align-items-center text-wrap bg-white shadow-sm rounded-3 px-2 py-2 my-4 cursor gap-2 "
                >
                  <UploadIcon />
